...
execute if entity @a[x=611,y=67,z=82,distance=45..,team=SnowBattle,name=!"mine_book000"] as @a[x=611,y=67,z=82,distance=45..,team=SnowBattle,name=!"mine_book000"] run team leave @a[x=611,y=67,z=82,distance=45..,team=SnowBattle,name=!"mine_book000"]
